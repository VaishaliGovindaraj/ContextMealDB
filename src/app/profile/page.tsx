  ...
  return (
    <>
      ...
      {user?.favouriteCategory &&
        <Link className="text-black font-semibold text-center mb-2" href={`/category/${user.favouriteCategory}`}> Click to view the recipies of :<strong>{user.favouriteCategory}</strong></Link>}
